  ...
  return ( 
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md '>
      <div className='flex items-center justify-between'>
        <p className='text_para mt-0 font-semibold'> Visit fees</p>
        <span className='text-[14px] leading-7 lg:text-[16px] lg:leading-8 text-headingColor font-semibold'>500 INR</span>
      </div>
      ...
      <button className='btn text-[16px] px-5 py-3 w-full rounded-md'>Book Appointment</button>
    </div>
  );
}
